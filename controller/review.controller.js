...
//         return res
//           .status(HTTP_STATUS.OK)
//           .send(failure("Failed to delete review", validation[0].msg));
//       }
...
//       const deletedItem = await Review.findOneAndUpdate(
//         { doctorId: productId, "reviews.user": userId },
...
//       const productReview = await Review.findOne({ doctorId: productId });
...
//           .send(success("Review deleted successfully", productReview));
//       }
...
//       return res
//         .status(HTTP_STATUS.ACCEPTED)
//         .send(success("Review deleted successfully", productReviewObj));
//     } catch (error) {
//       console.log(error);
//       return res
//         .status(HTTP_STATUS.INTERNAL_SERVER_ERROR)
...
//         return res
//           .status(HTTP_STATUS.OK)
//           .send(failure("Failed to update review", validation[0].msg));
//       }
...
//       const updatedItem = await Review.findOneAndUpdate(
//         { doctorId: productId, "reviews.user": userId },
...
//       return res
//         .status(HTTP_STATUS.ACCEPTED)
//         .send(success("Review updated successfully", productReview));
//     } catch (error) {
//       console.log(error);
//       return res
//         .status(HTTP_STATUS.INTERNAL_SERVER_ERROR)
